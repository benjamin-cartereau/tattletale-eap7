...
public class Dump
{
                                    ...
                                    String outputDir)
   {
      try
      {
         ...
         if(!dependenciesReports.isEmpty()){
         ...
         if(!customReports.isEmpty()){
        	 generateReportItems(bw, customReports, "JBoss EAP and Java EE", false);
         }
         if(!archiveReports.isEmpty()){
             generateReportItems(bw, archiveReports, "Analyzed archives", true);
         }
